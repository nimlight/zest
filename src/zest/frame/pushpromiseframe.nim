...
proc initPushPromiseFrame*(streamId: StreamId, promiseStreamId: StreamId, headerBlockFragment: seq[byte],
  ...
  PushPromiseFrame(headers: headers, promisedStreamID: promiseStreamId, headerBlockFragment: headerBlockFragment, padding: padding)
...
proc readPushPromiseFrame*(stream: StringStream): PushPromiseFrame {.inline.} =
